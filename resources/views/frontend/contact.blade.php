            ...
            <div class="bg-white rounded-lg shadow-md p-8">
                ...
                <form method="POST" action="{{ route('contact.store') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-2">{{ $settings['contact_label_name'] ?? 'Name *' }}</label>
                        ...
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-2">{{ $settings['contact_label_email'] ?? 'Email *' }}</label>
                    ...
                    <div>
                        <label for="phone" class="block text-sm font-medium text-gray-700 mb-2">{{ $settings['contact_label_phone'] ?? 'Phone' }}</label>
                    ...
                    <div>
                            <label for="subject" class="block text-sm font-medium text-gray-700 mb-2">{{ $settings['contact_label_subject'] ?? 'Subject *' }}</label>
                    ...
                    <div>
                        <label for="message" class="block text-sm font-medium text-gray-700 mb-2">{{ $settings['contact_label_message'] ?? 'Message *' }}</label>
                ...
                <div class="bg-white rounded-lg shadow-md p-8">
                    ...
                    <div class="flex space-x-4">
                        @if(($settings['social_facebook'] ?? false) || ($settings['facebook_url'] ?? false))
                            <a href="{{ $settings['social_facebook'] ?? $settings['facebook_url'] }}" 
                        ...
                        @if(($settings['social_twitter'] ?? false) || ($settings['twitter_url'] ?? false))
                            <a href="{{ $settings['social_twitter'] ?? $settings['twitter_url'] }}" 
                        ...
                        @if(($settings['social_instagram'] ?? false) || ($settings['instagram_url'] ?? false))
                            <a href="{{ $settings['social_instagram'] ?? $settings['instagram_url'] }}" 
                        ...
                        @if(($settings['social_linkedin'] ?? false) || ($settings['linkedin_url'] ?? false))
                            <a href="{{ $settings['social_linkedin'] ?? $settings['linkedin_url'] }}" 
